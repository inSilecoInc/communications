...
<div style="display: flex; justify-content: center; align-items: center;">
  <div><img src="../img/hex-TWC.png" width="150"></div>
</div>
<br>
<div style="display: flex; justify-content: center; align-items: center;">
  <div style="margin-left: 0px;"><img src="../img/insileco_logo256.png" width="100"></div>
  <div style="margin-left: 200px;"><img src="../img/logo_cfem2.png" width="100"></div>
</div>
...
1. Fish and fish prey timing window database.
2. Statistical models and risk analysis for future users.
3. Timing Windows shiny app calculator for management and policy decisions.
...
1. Effect of perturbations on a stage-structured spatial foodweb
2. Assessing optimal timing windows for freshwater interventions through a cumulative risk framework 
...
- Undertanding of disturbance spread to other:
  - life stages 
  - species
- Integration of concepts to timing windows assessment
